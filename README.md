...
- [xLLiM installation options](#xllim-installation-options)
  ...
  - [2. PyPI](#2-pypi)
  - [3. Docker / Apptainer (Singularity)](#3-docker--apptainer-singularity)
    - [Docker](#docker)
...
**Prerequisites:** install [Docker Engine](https://docs.docker.com/engine/install/) (Linux/macOS) or [Docker Desktop](https://docs.docker.com/desktop/windows/install/) (Windows).
...
```
> Note: specific versions are also available. See [xLLiM GHCR](https://github.com/xllim-tools/xllim/pkgs/container/xllim%2Fxllim/versions).
...
[Apptainer](https://apptainer.org/) (formerly Singularity) is a container runtime designed for HPC environments where Docker is typically not available or not allowed. It runs rootless and is natively supported on most HPC schedulers (SLURM, PBS, etc.).
...
**Prerequisite:** [Apptainer](https://apptainer.org/docs/user/latest/quick_start.html) must be installed on your system (typically already available on HPC clusters - check with your sysadmin).
...
```
> Available versions: [xLLiM GHCR](https://github.com/xllim-tools/xllim/pkgs/container/xllim%2Fxllim/versions).
